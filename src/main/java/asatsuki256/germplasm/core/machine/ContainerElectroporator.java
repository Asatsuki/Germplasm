...
public class ContainerElectroporator extends Container {
	
	private final IItemHandler inventory;
	int xCoord, yCoord, zCoord;
	
	public ContainerElectroporator(int x, int y, int z, InventoryPlayer inventoryPlayer, TileElectroporator tile) {
		this.xCoord = x;
        this.yCoord = y;
        this.zCoord = z;
        ...
        //recipe
        this.addSlotToContainer(new SlotItemHandlerIngredient((IItemHandlerModifiable)inventory, 0, 46, 49));
        this.addSlotToContainer(new SlotItemHandlerIngredient((IItemHandlerModifiable)inventory, 1, 46, 85));
        this.addSlotToContainer(new SlotItemHandler(inventory, 2, 116, 49));
