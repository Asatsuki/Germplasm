...
public class SeedModelLoader implements ICustomModelLoader{

	private static ModelResourceLocation mrlMain = new ModelResourceLocation(MODID + ":seed_sample", "inventory");
