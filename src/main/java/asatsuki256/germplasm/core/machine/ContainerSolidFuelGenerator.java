...
public class ContainerSolidFuelGenerator extends Container {
	...
	public ContainerSolidFuelGenerator(int x, int y, int z, InventoryPlayer inventoryPlayer, TileSolidFuelGenerator tile) {
		this.xCoord = x;
        this.yCoord = y;
        this.zCoord = z;
        ...
        //recipe
        this.addSlotToContainer(new SlotItemHandler(inventory, 0, 81, 64));
