...
public class ContainerDnaExtractor extends Container {
	...
	public ContainerDnaExtractor(int x, int y, int z, InventoryPlayer inventoryPlayer, TileDnaExtractor tile) {
		this.xCoord = x;
        this.yCoord = y;
        this.zCoord = z;
        ...
        //recipe
        this.addSlotToContainer(new SlotItemHandlerIngredient((IItemHandlerModifiable)inventory, 0, 54, 58));
        this.addSlotToContainer(new SlotItemHandler(inventory, 2, 108, 58));
        //ingredient fluid
        this.addSlotToContainer(new SlotItemHandlerIngredient((IItemHandlerModifiable)inventory, 1, 7, 34));
        this.addSlotToContainer(new SlotItemHandler(inventory, 3, 7, 82));
        //result fluid
